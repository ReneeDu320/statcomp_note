...
plot(varImp(object=linearSVM),   main="Linear SVM ")
# assess the variable importance for RBF SVM
plot(varImp(object=RBFSVM),   main="RBFSVM ")
```

The plots show that the most important variable are V4, V12 and V14.
...
ggplot(x, aes(V12,V14,col=y)) + geom_point() + 
  geom_point(data=rsv, col="purple", size=2) +
  geom_contour(data=grid3, aes(V12,V14,z=yy), breaks=0, col="purple") +
...
ggplot(x, aes(V12,V14,col=y)) + geom_point() + 
  geom_point(data=rsv, col="green", size=2) +
  geom_contour(data=grid4, aes(V12,V14,z=yy), breaks=0, col="green") +
...
There is no big difference between the decisoin boundary from the plots.